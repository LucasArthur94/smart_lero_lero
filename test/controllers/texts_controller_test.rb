...
class TextsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create text" do
    assert_difference('Text.count') do
      post texts_url, params: { text: { char_quantity: @text.char_quantity, generated_text: @text.generated_text, language_iso: @text.language_iso, paragraphs: @text.paragraphs, words: @text.words } }
    end
  ...
  test "should update text" do
    patch text_url(@text), params: { text: { char_quantity: @text.char_quantity, generated_text: @text.generated_text, language_iso: @text.language_iso, paragraphs: @text.paragraphs, words: @text.words } }
